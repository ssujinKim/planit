      ...
      <form name="themeForm" onsubmit="return check(this);" action="./result.jsp" method="post">
        ...
        <div class="form1">
          <div class="line_1">
            ...
            <label class="btn btn-outline-secondary" for="btn-check1" onclick='getCheckboxValue()'>#연인</label>
          </div>

          <div class="line_1">
            <input type="checkbox" class="btn-check" id="btn-check2" name="keyword" value="가족" autocomplete="off" />
            <label class="btn btn-outline-secondary" for="btn-check2" onclick='getCheckboxValue()'>#가족</label>
          </div>

          <div class="line_1">
            <input type="checkbox" class="btn-check" id="btn-check3" name="keyword" value="자연" autocomplete="off" />
            <label class="btn btn-outline-secondary" for="btn-check3" onclick='getCheckboxValue()'>#자연</label>
          </div>

          <div class="line_1">
            <input type="checkbox" class="btn-check" id="btn-check4" name="keyword" value="힐링" autocomplete="off" />
            <label class="btn btn-outline-secondary" for="btn-check4" onclick='getCheckboxValue()'>#힐링</label>
          </div>
        </div>
        <br />
        ...
        <div class="form2">
          ...
          <div class="line_2">
            <input type="checkbox" class="btn-check" id="btn-check6" name="keyword" value="분위기" autocomplete="off" />
            <label class="btn btn-outline-secondary" for="btn-check6">#분위기</label>
          </div>

          <div class="line_2">
            <input type="checkbox" class="btn-check" id="btn-check7" name="keyword" value="활동적" autocomplete="off" />
          ...
          <div class="line_2">
            <input type="checkbox" class="btn-check" id="btn-check9" name="keyword" value="로맨틱" autocomplete="off" />
        ...
        <div class="form3">
          <div class="line_3">
            <input type="checkbox" class="btn-check" id="btn-check10" name="keyword" value="쇼핑" autocomplete="off" />
            <label class="btn btn-outline-secondary" for="btn-check10">#쇼핑</label>
          </div>

          <div class="line_3">
            <input type="checkbox" class="btn-check" id="btn-check11" name="keyword" value="산책" autocomplete="off" />
            <label class="btn btn-outline-secondary" for="btn-check11">#산책</label>
          </div>

          <div class="line_3">
            <input type="checkbox" class="btn-check" id="btn-check12" name="keyword" value="레트로" autocomplete="off" />
            <label class="btn btn-outline-secondary" for="btn-check12">#레트로</label>
          </div>

          <div class="line_3">
            <input type="checkbox" class="btn-check" id="btn-check13" name="keyword" value="감상" autocomplete="off" />
