                  ...
                  <form action="./findIdCheck.jsp" class="form-signin">
                     <div class = "form_box">
                      ...
                      <div class = "form_box">
                        ...
                        <div class = "check">
                           <input type="tel" id="phone" class="form-control" name="phone" pattern="([0-9]{3}-[0-9]{4}-[0-9]{4})|([0][0-9]{10})" maxlength="13" placeholder="휴대폰 번호 (000-0000-0000 형식)" title="휴대폰 번호 (000-0000-0000 형식)" required>
                        </div>
                      </div>
